...
import { ArrowRight, ShieldCheck, Cpu, Cloud, Settings } from "lucide-react";
  ...
  return (
    <section className="relative w-full min-h-[90vh] flex items-center justify-center bg-zinc-950 overflow-hidden font-sans">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 flex flex-col items-center text-center">
        ...
        {/* Pilares Técnicos (Trust Indicators) */}
        <div className="mt-20 pt-8 border-t border-zinc-800/50 w-full max-w-4xl flex flex-wrap justify-center gap-x-8 gap-y-4 opacity-80">
           <div className="flex items-center text-zinc-400 gap-2 text-sm font-medium">
              <Cpu className="w-4 h-4 text-emerald-500/80" /> Edge AI & FPGA
           </div>
           <div className="flex items-center text-zinc-400 gap-2 text-sm font-medium">
              <ShieldCheck className="w-4 h-4 text-emerald-500/80" /> Hardware Security
           </div>
           <div className="flex items-center text-zinc-400 gap-2 text-sm font-medium">
              <Cloud className="w-4 h-4 text-emerald-500/80" /> Arquitectura Cloud IoT
           </div>
           <div className="flex items-center text-zinc-400 gap-2 text-sm font-medium">
